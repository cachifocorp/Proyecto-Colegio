<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion_Administracion/MasterPage.master" AutoEventWireup="true" CodeFile="Gestion.aspx.cs" Inherits="Asignacion_Grado_Gestion" %>
                            ...
                            <div class="form-vertical" id="frmAnio_Escolar_Periodo">
                                <div class="row-fluid">
                                    <div class="span12">
                                        ...
                                        <div class="span4">
                                            <div class="control-group">
                                                <asp:Label ID="lblContraccion" runat="server" Text="Contracción : " CssClass="control-label" AssociatedControlID="txtContraccion"></asp:Label>
                                                <div class="controls">
                                                    <asp:TextBox ID="txtContraccion" runat="server" CssClass="span12 obligatorio numerico entero" placeholder="Contracción" ></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
