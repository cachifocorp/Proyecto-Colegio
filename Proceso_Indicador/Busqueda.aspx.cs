...
public partial class Proceso_Indicador_Busqueda : System.Web.UI.Page
{
    ...
    {
        this.vertbl_Grupos_Boletin();
    }

    public void vertbl_Grupos_Boletin()
    {
        try
        {
            ...
            tbl_Boletin.DataSource                                  = objOperAsignacion.ConsultarAsignacion(objAsignacion);
            tbl_Boletin.DataBind();
    ...
    protected void tbl_Boletin_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        Response.RedirectToRoute("General", new { Modulo = "Proceso", Entidad = "Indicador", Pagina = "Gestion", Accion = "Edita", Id = clsEncriptar.Encriptar(tbl_Boletin.Rows[e.NewSelectedIndex].Cells[0].Text) });
    }
    protected void tbl_Boletin_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        tbl_Boletin.PageIndex = e.NewPageIndex;
        vertbl_Grupos_Boletin();
    }
