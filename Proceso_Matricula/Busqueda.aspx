<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion_Administracion/MasterPage.master" AutoEventWireup="true" CodeFile="Busqueda.aspx.cs" Inherits="Proceso_Matricula_Busqueda" %>
                        ...
                        <div class="widget-content">
                            <div class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls span5">
                                        <asp:DropDownList ID="ddlSalon" runat="server" AppendDataBoundItems="true" CssClass="combo">
                            ...
                            <asp:GridView ID="tbl_Matricula" runat="server" CssClass="table table-bordered table-hover responsive" EnableModelValidation="True" AllowPaging="True" DataKeyNames="Id" AutoGenerateColumns="False" OnPageIndexChanging="tbl_Matricula_PageIndexChanging" OnSelectedIndexChanging="tbl_Matricula_SelectedIndexChanging">
                                <Columns>
                                    <asp:TemplateField>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JavaScript" runat="Server">
    <script type="text/javascript">
        function Confirmar() {
            ...
            $("#<%=tbl_Matricula.ClientID%> :checkbox").each(function () {
                if (this.checked) {
                    seleccionado = true;
                }
            });
