<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion_Administracion/MasterPage.master" AutoEventWireup="true" CodeFile="Busqueda.aspx.cs" Inherits="Proceso_Observador_Busqueda" %>
        ...
        <ContentTemplate>
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" class="btn bg-red" ToolTip="Eliminar Elemento" OnClick="btnEliminar_Click"/>
                    <br />
                    <br />
                        ...
                        <div class="widget-content">
                            <div class="form-horizontal">
                                <div class="control-group">
                                    <asp:Label ID="lblEstudiante" runat="server" Text="Descripcion :" CssClass="control-label"></asp:Label>
                                    <div class="controls span5">
                                        <asp:TextBox ID="txtDescripcion" runat="server" CssClass="span12" placeholder="Documento Estudiante"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                            ...
                            <asp:GridView ID="tbl_Observador" runat="server" CssClass="table table-bordered table-hover responsive" EnableModelValidation="True" AllowPaging="True" DataKeyNames="Id" AutoGenerateColumns="False" OnPageIndexChanging="tbl_Observador_PageIndexChanging" OnSelectedIndexChanging="tbl_Observador_SelectedIndexChanging">
                                <Columns>
                                    <asp:TemplateField>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JavaScript" runat="Server">
    <script type="text/javascript">
        function Confirmar() {
            ...
            $("#<%=tbl_Observador.ClientID%> :checkbox").each(function () {
                if (this.checked) {
                    seleccionado = true;
                }
            });
