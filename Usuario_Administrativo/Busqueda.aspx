<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion_Administracion/MasterPage.master" AutoEventWireup="true" CodeFile="Busqueda.aspx.cs" Inherits="Usuario_Administrativo_Busqueda" %>
                        ...
                        <div class="widget-content">
                            <div class="form-horizontal">
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls span5">
                                        <asp:DropDownList ID="ddlTipo" runat="server" CssClass="obligatorio combo" AppendDataBoundItems="true" AutoPostBack="True">
                                            <asp:ListItem Text="--- SELECCIONE UNO ---" Value="0"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <asp:Label ID="Label1" runat="server" Text="" CssClass="control-label" AssociatedControlID="ddlTipo"></asp:Label>
                                    <div class="controls span5">
                                        <asp:Button ID="btnBuscar" runat="server" Text="Buscar" CssClass="btn bg-teal" ToolTip="Buscar Elemento" OnClick="btnBuscar_Click" />
                                    </div>
                                </div>
                            </div>
                            <asp:GridView ID="tbl_Administrativo" runat="server" CssClass="table table-bordered table-hover responsive" EnableModelValidation="True" AllowPaging="True" DataKeyNames="Id" AutoGenerateColumns="False" OnPageIndexChanging="tbl_Administrativo_PageIndexChanging" OnSelectedIndexChanging="tbl_Administrativo_SelectedIndexChanging">
                                <Columns>
                                    <asp:TemplateField>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JavaScript" runat="Server">
    <script type="text/javascript">
        function Confirmar() {
            ...
            $("#<%=tbl_Administrativo.ClientID%> :checkbox").each(function () {
                if (this.checked) {
                    seleccionado = true;
                }
            });
