<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion_Administracion/MasterPage.master" AutoEventWireup="true" CodeFile="Busqueda.aspx.cs" Inherits="Configuracion_Usuario_Busqueda" %>
                    ...
                    <div class="widget border-<%=clsConfiguracion.Color_Sistema%>" id="widget-tbordered">
                        ...
                        <div class="widget-content">
                            <div class="form-horizontal">
                                ...
                                <div class="control-group">
                                    <asp:Label ID="lblTipo_Usuario" runat="server" Text="Tipo Usuario :" CssClass="control-label"></asp:Label>
                                    <div class="controls span5">
                                        <asp:DropDownList ID="ddlTipo_Usuario" runat="server" CssClass="combo" AppendDataBoundItems="true">
                            ...
                            <asp:GridView ID="tbl_Usuario" runat="server" CssClass="table table-bordered table-hover responsive" EnableModelValidation="True" AllowPaging="True" DataKeyNames="Id" AutoGenerateColumns="False" OnPageIndexChanging="tbl_Usuario_PageIndexChanging" OnSelectedIndexChanging="tbl_Usuario_SelectedIndexChanging">
                                <Columns>
                                    <asp:TemplateField>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JavaScript" runat="Server">
    <script type="text/javascript">
        function Confirmar() {
            ...
            $("#<%=tbl_Usuario.ClientID%> :checkbox").each(function () {
                if (this.checked) {
                    seleccionado = true;
                }
            });
