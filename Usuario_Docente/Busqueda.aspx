<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion_Administracion/MasterPage.master" AutoEventWireup="true" CodeFile="Busqueda.aspx.cs" Inherits="Usuario_Docente_Busqueda" %>
                            ...
                            <div class="form-horizontal">
                                <div class="control-group">
                                    ...
                                    <div class="controls span5">
                                        <asp:TextBox ID="txtDescripcion" runat="server" CssClass="span12" placeholder="Documento Docente"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <asp:GridView ID="tbl_Docente" runat="server" CssClass="table table-bordered table-hover responsive" EnableModelValidation="True" AllowPaging="True" DataKeyNames="Id" AutoGenerateColumns="False" OnPageIndexChanging="tbl_Area_PageIndexChanging" OnSelectedIndexChanging="tbl_Area_SelectedIndexChanging">
                                    <Columns>
                                        <asp:TemplateField>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblNombre" Text='<%#Eval("nombres")+" "+Eval("apellidos")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <HeaderStyle Width="50px" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="JavaScript" runat="Server">
    <script type="text/javascript">
        function Confirmar() {
            ...
            $("#<%=tbl_Docente.ClientID%> :checkbox").each(function () {
                if (this.checked) {
                    seleccionado = true;
                }
            });
