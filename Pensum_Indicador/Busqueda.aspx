<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion_Administracion/MasterPage.master" AutoEventWireup="true" CodeFile="Busqueda.aspx.cs" Inherits="Pensum_Indicador_Busqueda" %>
                ...
                <div class="span12">
                    ...
                    <div class="widget border-<%=clsConfiguracion.Color_Sistema%>" id="widget-tbordered">
                        ...
                        <div class="widget-content">
                            ...
                            <asp:GridView ID="tbl_Indicador" runat="server" CssClass="table table-bordered table-hover responsive" EnableModelValidation="True" AllowPaging="True" DataKeyNames="Id" AutoGenerateColumns="False" OnPageIndexChanging="tbl_Indicador_PageIndexChanging" OnSelectedIndexChanging="tbl_Indicador_SelectedIndexChanging">
                                <Columns>
                                    <asp:TemplateField>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JavaScript" runat="Server">
    <script type="text/javascript">
        function Confirmar() {
            ...
            $("#<%=tbl_Indicador.ClientID%> :checkbox").each(function () {
                if (this.checked) {
                    seleccionado = true;
                }
            });
