<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion_Administracion/MasterPage.master" AutoEventWireup="true" CodeFile="Busqueda.aspx.cs" Inherits="Proceso_Calificacion_Busqueda" %>
                ...
                <div class="span12">
                    <div class="widget border-<%=clsConfiguracion.Color_Sistema%>" id="widget-tbordered">
                        ...
                        <div class="widget-content">
                            ...
                            <asp:GridView ID="tbl_Calificacion" runat="server" CssClass="table table-bordered table-hover responsive" EnableModelValidation="True" AllowPaging="True" DataKeyNames="Id" AutoGenerateColumns="False" OnPageIndexChanging="tbl_Calificacion_PageIndexChanging" OnSelectedIndexChanging="tbl_Calificacion_SelectedIndexChanging">
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <HeaderTemplate>
                                            <asp:Label ID="lblCalificar" runat="server" Text="Calificar"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
