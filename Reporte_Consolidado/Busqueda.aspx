<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion_Administracion/MasterPageFull.master" AutoEventWireup="true" CodeFile="Busqueda.aspx.cs" Inherits="Reporte_Consolidado_Busqueda" %>
                    ...
                    <div class="widget border-<%=clsConfiguracion.Color_Sistema%>" id="widget-tbordered">
                        ...
                        <div class="widget-content">
                            <div class="form-horizontal">
                                ...
                                <div class="control-group">
                                    <asp:Label ID="lblAcumulado" runat="server" Text="Acumulado :" CssClass="control-label" AssociatedControlID="ddlPeriodo"></asp:Label>
                                    <div class="controls span5">
                                        <asp:CheckBox ID="chkAcumulado" runat="server" Text="Acumulado" />
                                    </div>
                                </div>
                                <div class="control-group">
