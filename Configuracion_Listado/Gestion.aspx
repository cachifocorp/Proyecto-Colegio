<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion_Administracion/MasterPage.master" AutoEventWireup="true" CodeFile="Gestion.aspx.cs" Inherits="Configuracion_Listado_Gestion" %>
                                    ...
                                    <div class="span12">
                                        ...
                                        <div class="span4">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <asp:DropDownList ID="ddlTipo_Listado" runat="server" CssClass="span12 obligatorio combo" AppendDataBoundItems="true">
