<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion_Administracion/MasterPage.master" AutoEventWireup="true" CodeFile="Busqueda.aspx.cs" Inherits="Configuracion_Listado_Busqueda" %>
                    ...
                    <div class="widget border-<%=clsConfiguracion.Color_Sistema%>" id="widget-tbordered">
                        ...
                        <div class="widget-content">
                            <div class="form-horizontal">
                                ...
                                <div class="control-group">
                                    <asp:Label ID="lblTipo_Listado" runat="server" Text="Tipo Listado :" CssClass="control-label" AssociatedControlID="ddlTipo_Listado"></asp:Label>
                                    <div class="controls span5">
                                        <asp:DropDownList ID="ddlTipo_Listado" runat="server" CssClass="combo" AppendDataBoundItems="true">
                                ...
                                <asp:GridView ID="tbl_Listado" runat="server" CssClass="table table-bordered table-hover responsive" EnableModelValidation="True" AllowPaging="True" DataKeyNames="Id" AutoGenerateColumns="False" OnPageIndexChanging="tbl_Listado_PageIndexChanging" OnSelectedIndexChanging="tbl_Listado_SelectedIndexChanging">
                                    <Columns>
                                        <asp:TemplateField>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JavaScript" runat="Server">
    <script type="text/javascript">
        function Confirmar() {
            ...
            $("#<%=tbl_Listado.ClientID%> :checkbox").each(function () {
                if (this.checked) {
                    seleccionado = true;
                }
            });
