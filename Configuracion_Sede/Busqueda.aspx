<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion_Administracion/MasterPage.master" AutoEventWireup="true" CodeFile="Busqueda.aspx.cs" Inherits="Configuracion_Sede_Busqueda" %>
                    ...
                    <div class="widget border-<%=clsConfiguracion.Color_Sistema%>" id="widget-tbordered">
                        ...
                        <div class="widget-content">
                            <div class="form-horizontal">
                                ...
                                <asp:GridView ID="tbl_Sede" runat="server" CssClass="table table-bordered table-hover responsive" EnableModelValidation="True" AllowPaging="True" DataKeyNames="Id" AutoGenerateColumns="False" OnPageIndexChanging="tbl_Sede_PageIndexChanging" OnSelectedIndexChanging="tbl_Sede_SelectedIndexChanging">
                                    <Columns>
                                        <asp:TemplateField>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JavaScript" runat="Server">
    <script type="text/javascript">
        function Confirmar() {
            ...
            $("#<%=tbl_Sede.ClientID%> :checkbox").each(function () {
                if (this.checked) {
                    seleccionado = true;
                }
            });
