<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion_Administracion/MasterPage.master" AutoEventWireup="true" CodeFile="Busqueda.aspx.cs" Inherits="Asignacion_Salon_Busqueda" %>
                    ...
                    <div class="widget border-<%=clsConfiguracion.Color_Sistema%>" id="widget-tbordered">
                        ...
                        <div class="widget-content">
                            <div class="form-horizontal">
                                ...
                                <div class="control-group">
                                    <asp:Label ID="lblSede" runat="server" Text="Sede :" CssClass="control-label" AssociatedControlID="ddlSede"></asp:Label>
                                    <div class="controls span5">
                                        <asp:DropDownList ID="ddlSede" runat="server" CssClass="combo" AppendDataBoundItems="true">
                                            <asp:ListItem Text="--- SELECCIONE UNO ---" Value="0"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <asp:Label ID="lblJornada" runat="server" Text="Jornada :" CssClass="control-label" AssociatedControlID="ddlJornada"></asp:Label>
                                    <div class="controls span5">
                                        <asp:DropDownList ID="ddlJornada" runat="server" CssClass="combo" AppendDataBoundItems="true">
                                            <asp:ListItem Text="--- SELECCIONE UNO ---" Value="0"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <asp:Label ID="lblDirector" runat="server" Text="Director :" CssClass="control-label" AssociatedControlID="ddlDirector"></asp:Label>
                                    <div class="controls span5">
                                        <asp:DropDownList ID="ddlDirector" runat="server" CssClass="combo" AppendDataBoundItems="true">
                                            <asp:ListItem Text="--- SELECCIONE UNO ---" Value="0"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                ...
                                <asp:GridView ID="tbl_Salon" runat="server" CssClass="table table-bordered table-hover responsive" EnableModelValidation="True" AllowPaging="True" DataKeyNames="Id" AutoGenerateColumns="False" OnPageIndexChanging="tbl_Salon_PageIndexChanging" OnSelectedIndexChanging="tbl_Salon_SelectedIndexChanging" PagerSettings-PageButtonCount="10" PageSize="7">
                                    <Columns>
                                        <asp:TemplateField>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JavaScript" runat="Server">
    <script type="text/javascript">
        function Confirmar() {
            ...
            $("#<%=tbl_Salon.ClientID%> :checkbox").each(function () {
                if (this.checked) {
                    seleccionado = true;
                }
            });
